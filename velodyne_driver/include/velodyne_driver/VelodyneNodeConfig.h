  ...
  public:
    ...
    void setParams(VelodyneNodeConfig &config, const std::vector<AbstractParamDescriptionConstPtr> params)
    {
      for (std::vector<AbstractParamDescriptionConstPtr>::const_iterator _i = params.begin(); _i != params.end(); ++_i)
      {
        ...
        if("scan_phase"==(*_i)->name){scan_phase = boost::any_cast<double>(val);}
      }
    }
...
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __min__.scan_phase = 0.0;
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __max__.scan_phase = 359.0;
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __default__.scan_phase = 0.0;
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(VelodyneNodeConfig::AbstractParamDescriptionConstPtr(new VelodyneNodeConfig::ParamDescription<double>("scan_phase", "double", 0, "The start/end phase for the scane (in degrees).", "", &VelodyneNodeConfig::scan_phase)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __param_descriptions__.push_back(VelodyneNodeConfig::AbstractParamDescriptionConstPtr(new VelodyneNodeConfig::ParamDescription<double>("scan_phase", "double", 0, "The start/end phase for the scane (in degrees).", "", &VelodyneNodeConfig::scan_phase)));
